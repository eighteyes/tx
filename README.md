...
**H**umans **Y**eeting **D**irectional **R**ecursive **A**lchemy
...
- [Included Meshes](#included-meshes)
...
| **Bash Guard**   | Enforces workDir boundary for Bash commands. Blocks writes outside project dir, catastrophic commands (sudo, rm -rf /, reboot). | [`guardrails.bash_guard`](docs/guardrails.md#bash-guard) |
...
See [Mesh List](docs/MESH_LIST.md) for the complete list of meshes.
...
- [safe-claude](https://github.com/eighteyes/safe-claude) — quick docker sandbox for agentic development

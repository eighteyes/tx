...
└── reference/
    ...
    └── support.md (tickets, customer data)
```

SKILL.md contains high-level guidance on which reference file to read based on the query.

**Pattern 3: Framework selection**

For skills supporting multiple frameworks, organize by framework:
```
frontend-skill/
...
└── frameworks/
    ...
    ├── vue.md (Vue patterns)
    └── vanilla.md (Plain JavaScript)
```

SKILL.md helps Claude pick the right framework file, which contains the specific patterns.

**Pattern 4: Operation-specific guides**

For skills with many specialized operations, organize by operation type:
```
excel-skill/
├── SKILL.md (common operations)
└── operations/
    ├── formulas.md (complex formulas)
    ├── charts.md (visualization)
    ├── pivot.md (pivot tables)
    └── macros.md (VBA automation)
```

SKILL.md covers basics; Claude reads specialized files when needed.

...
# INTELLIGENT: overthinking causes paralysis
TRAIT_MOD[INTELLIGENT,catastrophic]=-1;  TRAIT_MOD[INTELLIGENT,failure]=2;  TRAIT_MOD[INTELLIGENT,mixed]=1;  TRAIT_MOD[INTELLIGENT,success]=-1;  TRAIT_MOD[INTELLIGENT,breakthrough]=-1
# SMUG: pride before fall, confidence → success
TRAIT_MOD[SMUG,catastrophic]=1;  TRAIT_MOD[SMUG,failure]=-1;  TRAIT_MOD[SMUG,mixed]=-1;  TRAIT_MOD[SMUG,success]=1;  TRAIT_MOD[SMUG,breakthrough]=0
# ANGRY: creates extremes, burns middle ground
TRAIT_MOD[ANGRY,catastrophic]=3;  TRAIT_MOD[ANGRY,failure]=-2;  TRAIT_MOD[ANGRY,mixed]=-2;  TRAIT_MOD[ANGRY,success]=1;  TRAIT_MOD[ANGRY,breakthrough]=0

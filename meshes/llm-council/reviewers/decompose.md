# Alpha Reviewer — Decomposition Lens
...
## Review Lens: DECOMPOSE

Evaluate each response through the decomposition lens:
- Did it identify the real constraints?
- Is the analysis modular — can parts be used independently?
- Are subproblems cleanly separated or muddled together?
- Does the composition hold — do the parts actually assemble into a whole?
- Are gaps and missing information acknowledged?

...
5b. **Never narrate what the action already showed** — "The shift wasn't violation. It was trust made physical." is the narrator explaining. "Her hand moved to Heather's waist. No flinch." is the action showing trust. If the reader can see it from the physical action, the narrator doesn't need to name it. Cut every sentence that explains the meaning of the preceding sentence.
